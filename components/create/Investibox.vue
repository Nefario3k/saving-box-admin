      ...
      >
        <div>
          <div class="right-drawer-title">
            <h1 class="">Create New Investment</h1>
            <p>Create new investment details</p>
          </div>
          ...
          <section class="input__area update-form">
            <div class="row">
              ...
              <!-- Category  -->
              <div class="col-12">
                <label class="form-label label-design">Category</label>
              ...
              <!-- Company Location  -->
              <div class="col-12">
                <label for="companyLocation" class="form-label label-design"
