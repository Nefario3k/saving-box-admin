        ...
        <div>
          ...
          <section class="input__area update-form">
            <div class="row">
              <!-- Item Name  -->
              <div class="col-12">
                <label for="jollyName" class="form-label label-design"
                  >Item Name</label
                >
                <input
                  type="text"
              ...
              <!-- Amount  -->
              <div class="col-12">
                <label for="amount" class="form-label label-design"
                  >Amount</label
                >
                <input
                  type="number"
              ...
              <div class="col-12">
                ...
                >
                <textarea
                  class="input-design-textarea shortArea shorterArea"
