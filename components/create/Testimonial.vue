      ...
      >
        <div>
          <div class="right-drawer-title">
            <h1 class="">Create New Testimonial</h1>
          ...
          <section class="input__area update-form">
            <div class="row">
              ...
              <!-- Quote  -->
              <div class="col-12">
                <label for="desc" class="form-label label-design">Quote</label>
                <textarea
                  id="desc"
              ...
              <div class="col-12">
                ...
                <div class="mt-5 text-center">
                  <v-rating
                    ...
                    size="34"
                    color="#7DA54A"
                    background-color="#7DA54A lighten"
                    :value="1"
                  ></v-rating>
                </div>
              </div>
              <div style="margin-top: 38px" class="col-12">
                <button
        ...
        <div>
          <div class="right-drawer-title">
            ...
            <p
              ...
              "
            >
              New user testimonial has been created successfully.
            </p>
          </div>
          <section class="input__area update-form">
            <div class="row">
