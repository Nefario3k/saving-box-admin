<template>
  <div>
            ...
            <v-list class="dropdown__list">
              ...
              >
                <v-list-item-title class="dropdown__list-title"
                  >View Portfolio</v-list-item-title
                >
              </v-list-item>
              <v-list-item
                @click="showPanel('disable')"
                class="dropdown__list-item"
              >
                <v-list-item-title class="dropdown__list-title"
    ...
    <ViewSingleInvestibox ref="viewInvestibox" />
    <ViewDisableSingleInvestibox ref="disable" />
  </div>
</template>
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "UNITS BOUGHT", value: "email" },
        { text: "ACCRUED ROI", value: "payment" },
        { text: "CAPITAL INVESTED", value: "category" },
        { text: "DUE AMOUNT", value: "balance" },
