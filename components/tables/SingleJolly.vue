<template>
  <div>
      ...
      <template v-slot:item.user="{ item }">
        <div class="user_content">
          <div class="user_content_details">
            <span @click="showPanel('jollyPlan')">
              {{ item.user }}
            </span>
          </div>
        </div>
    ...
    <ViewJollyPlan ref="jollyPlan" />
    <EditJolly @continueStep="showPanel('editJollyContinue')" ref="editJolly" />
    <EditJollyContd
      @showAddJolly="showPanel('addJolly')"
      ref="editJollyContinue"
    />
    <CreateJollyItem
      @continueItemStep="showPanel('editJollyContinue')"
      ref="addJolly"
    />
...
export default {
  data() {
    return {
      ...
      headers: [
        ...
        { text: "amount", value: "category" },
        { text: "STATUS", value: "due" },
        { text: "joined", value: "status" },
  ...
  methods: {
    showPanel(type) {
      switch (type) {
        case "jollyPlan":
          this.$refs.jollyPlan.showPanel();
          break;
        case "editJolly":
          this.$refs.editJolly.showPanel();
          break;
        case "editJollyContinue":
          this.$refs.editJollyContinue.showPanel();
          break;
        case "addJolly":
