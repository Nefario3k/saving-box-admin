<template>
  <div>
    ...
    <EditAdmin ref="adminEdit" />
    <ViewDisableAdmin ref="disableAdmin" />
  </div>
</template>
    ...
    showPanel(type) {
      switch (type) {
        case "view":
          ...
          break;
        case "edit":
          this.$refs.adminEdit.showPanel();
          break;
        case "disableAdmin":
          this.$refs.disableAdmin.showPanel();
          break;
