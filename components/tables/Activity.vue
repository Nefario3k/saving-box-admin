...
export default {
  data() {
    return {
      headers: [
        ...
        { text: "LAST ACTIVITY", value: "role" },
        { text: "WHERE", value: "date" },
  ...
  methods: {
    showPanel(type) {
      switch (type) {
        case "viewActivity":
          this.$refs.viewActivity.showPanel();
          break;
