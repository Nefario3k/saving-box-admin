      ...
      >
        <div>
          <div class="right-drawer-title">
            <h1 class="">Upcoming Transactions</h1>
            <p>View all transactions and invoices</p>
          </div>

          <div v-for="n in 20" :key="n" class="tab__items">
            ...
            <div class="tab__wrapper">
              ...
              <p @click="clearPayment" class="value action">Clear Payment</p>
            </div>
          </div>
        </div>
      </div>
