      ...
      >
        <div>
          <div class="right-drawer-title">
            <h1 class="">Clear Loan Payment</h1>
            <p>
              You are about to clear this loan repayment invoice for this user
              an this action can not be reversed
            </p>
          </div>
          ...
          <section class="input__area update-form">
            <div class="row">
              ...
              <div class="col-12">
                <button class="btn btn-primary btn-design">Clear</button>
              </div>
            </div>
          </section>
        </div>
