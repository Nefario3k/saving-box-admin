      ...
      >
        <div>
          <div class="right-drawer-title">
            <h1 class="">Disable Investment</h1>
            <p>State reasons for disabling this investment</p>
          </div>

          <section class="input__area update-form">
            <div class="row">
              <!-- Why do you want to disable this investment  -->
              <div class="col-12">
                <label for="planTitle" class="form-label label-design"
                  >Why do you want to disable this investment</label
                >
                <textarea
                  class="input-design-textarea"
                  placeholder="eg: Your document are not valid. we need documet from July to Decembet"
                  name=""
                  id=""
                ></textarea>
              </div>
              ...
              <div style="margin-top: 130px" class="col-12">
                <button class="btn btn-primary btn-design">Disable</button>
              </div>
            </div>
          </section>
        </div>
