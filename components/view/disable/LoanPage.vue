      ...
      >
        <div>
          <div class="right-drawer-title">
            <h1 class="">Reject Loan Request</h1>
            <p>State reason for rejecting a loan</p>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-12">
                <label class="form-label label-design"
                  >Why is the request rejected?</label
                >
              ...
              <div style="margin-top: 130px" class="col-12">
                <button class="btn btn-primary btn-design">Reject</button>
              </div>
            </div>
          </section>
        </div>
