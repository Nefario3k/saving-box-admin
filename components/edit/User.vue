      ...
      >
        <div>
          <div class="right-drawer-title">
            ...
            <p>Enter and Update details of user</p>
          </div>
          ...
          <section class="input__area update-form">
            <div class="row">
              ...
              <!-- dob  -->
              <div class="col-12">
                <label for="userDob" class="form-label label-design"
                  >Date of Birth</label
                >
                <input
                  type="date"
              ...
              <!-- gender  -->
              <div class="col-12">
                <label class="form-label label-design">Gender</label>
                <v-menu :nudge-bottom="3" offset-y>
                  ...
                  <v-list class="dropdown__list">
                    ...
                    <v-list-item class="dropdown__list-item">
                      <v-list-item-title class="dropdown__list-title"
                        >Female</v-list-item-title
                      >
                    </v-list-item>
                    <v-list-item class="dropdown__list-item">
                      <v-list-item-title class="dropdown__list-title"
                        >Non Binary</v-list-item-title
                      >
                    </v-list-item>
                    <v-list-item class="dropdown__list-item">
                      <v-list-item-title class="dropdown__list-title"
                        >Amoeba</v-list-item-title
                      >
                    </v-list-item>
                  </v-list>
                </v-menu>
