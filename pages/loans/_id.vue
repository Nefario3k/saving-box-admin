    ...
    <v-row class="row__content">
      <div class="col-12">
        <v-card color="#fff" class="profile__card not__profile__card">
          <header>
            <span>SMEs Loan <span class="value">(3)</span></span>
          </header>
          ...
          <div style="width: 100%; max-width: 43.8rem">
            <v-tabs
              :show-arrows="true"
              center-active
              v-model="savingsTab"
              ...
              class="v-tabs-styles"
            >
              <v-tab :ripple="false"> Active Loan</v-tab>
              <v-tab :ripple="false">Completed </v-tab>
              <v-tab :ripple="false"> Defaulted </v-tab>
            </v-tabs>
          </div>
